...
#######################################
spark-submit --class SVD --master yarn --deploy-mode client --executor-memory 1G SVD-Matrix-0.0.1-SNAPSHOT-jar-with-dependencies.jar matrixInput/matrix.csv >  svd_on_matrix_input.txt
